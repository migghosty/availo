...
/**
 * The interactive half of the login page. Split out so `page.tsx` can stay a
 * server component and read the business name for its heading — a client
 * component can't reach the database, and `useActionState` needs one.
 */
